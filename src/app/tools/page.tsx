    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Yes! All 100 growth utilities, calculators, caption generators, script outline builders, and DM copy previewers are 100% free with zero sign-up required.'
        }
      },
      {
        '@type': 'Question',
