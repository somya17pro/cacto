...
Also state: **design pattern** used (from `ad-design-patterns.md`) and **images needed**.
...
Do not use a template from this file. Follow `tla-writing.md` - TLAs are written as a real person's organic post, with their own rules, interview inputs and checklist.
