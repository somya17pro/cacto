...
console.log('🛠️ Normalizing and repairing all 1,010 tool entries in src/utils/toolsData.ts...');
...
if (headerIndex !== -1) {
  ...
  if (helperIndex !== -1) {
    ...
    console.log('✅ Successfully normalized and saved all 1,010 tools in src/utils/toolsData.ts!');
  } else {
